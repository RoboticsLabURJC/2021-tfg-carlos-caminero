...
#ifndef TEST_BTS__VACUUM_CLEANER__RECHARGE_HPP_
#define TEST_BTS__VACUUM_CLEANER__RECHARGE_HPP_
...
{
public:
  explicit Recharge(const std::string & name);
  void halt() override;
...
#endif  // TEST_BTS__VACUUM_CLEANER__RECHARGE_HPP_
